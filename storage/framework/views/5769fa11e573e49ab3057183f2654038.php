            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="mb-6">
                        ...
                        <p><strong>Order Date:</strong> <?php echo e($order->created_at->format('F j, Y, g:i a')); ?></p>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <?php $__currentLoopData = $order->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900">$<?php echo e(number_format($item->price, 2)); ?></div>
                                    </td>
                                </tr>
                    ...
                    <div class="mt-6">
                        <a href="<?php echo e(route('home')); ?>" class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded">
                            Continue Shopping
                        </a>
                    </div>
                </div>
...
<?php /**PATH C:\xampp\htdocs\furniture1\resources\views/orders/confirmation.blade.php ENDPATH**/ ?>